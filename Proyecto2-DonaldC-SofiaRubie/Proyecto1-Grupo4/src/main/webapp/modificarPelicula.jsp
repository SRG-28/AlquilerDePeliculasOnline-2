...
<head>
    ...
    <title>Actualizar Peliculas</title>
    <base href="www.actualizarPeliculas.com">
...
<section >
    <div class="container"  style="background-image: url(images/admiFondo.png);" >
        <div id="squareA2">
            <form name= "actualizarPeliculas" action="." method="POST"   onsubmit="validarTodo()">
                <h1 i class="fa fa-film aria-hidden=true, form-groupA"> &nbsp; ACTUALIZAR PELICULAS</h1>
