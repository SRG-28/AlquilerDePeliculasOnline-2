...
<head>
    ...
    <base href="www.eliminarPeliculas.com">
...
<section >
    <div class="container"  style="background-image: url(images/admiFondo.png);" >
        <div id="squareA2">
            <form name= "eliminarPeliculas" action="." method="POST"   onsubmit="validarTodo()">
                <h1 i class="fa fa-ban aria-hidden=true, form-groupA"> &nbsp; ELIMINAR PELICULAS</h1>
